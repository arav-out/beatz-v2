...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (e: { currentTarget: HTMLLIElement }, index: number) => {
          ...
          >
            {items.map((item, index) => (
              <button
                key={index}
                onClick={() => {
                  handleClick({ currentTarget: navRef.current?.children[index] as HTMLLIElement }, index);
                  item.onClick && item.onClick(); // Trigger the item's onClick if provided
                }}
